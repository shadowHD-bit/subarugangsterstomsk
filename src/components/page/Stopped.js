                    ...
                    <InfoRow >
                        <Column1>
                            <TextWrapper>
                                ...
                                <Heading> 
                                Проточка тормозных дисков на автомобиле
                                </Heading>
                                
                                <Subtitle>Проточка тормозных дисков позволяет восстановить их геометрию — устранить биение, нивелировать разнотолщинность. Кроме этого, исчезает излишняя шероховатость и замедляется износ колодок. Однако при проточке диск становится тоньше — эта операция не только не возвращает дискам их первоначальный ресурс, а наоборот снижает его.</Subtitle>
